...
```bash
docker build --target development --no-cache --tag test:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 test:development
```
...
```bash
docker run -e PORT=3001 -p 3001:3001 test
```
